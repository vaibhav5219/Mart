...
/****** Object:  Database [cartDB]    Script Date: 13-09-2022 21:50:23 ******/
CREATE DATABASE [martDB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'cartDB', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\cartDB.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'cartDB_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\cartDB_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [cartDB] SET RECOVERY SIMPLE 
GO
...
ALTER DATABASE [cartDB] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
